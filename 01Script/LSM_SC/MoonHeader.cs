...
public class MoonHeader : MonoBehaviour
{
	...
	public struct S_MinionStats		// 미니언의 상태에 관련된 구조체.
	{
		...
		public void Setting(int mh, float sp, int atk, GameObject[] des, Team t, MonType type_d, int e)    
	...
	public struct S_TurretStats	// 터렛(포탑)의 상태에 대한 구조체.
	{
		...
		public S_TurretStats(int h, int a, Team t) { actorHealth = new S_ActorState(h, a, t); }
